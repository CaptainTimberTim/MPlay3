...
#define NewSSC NewStaticStringCompound
    const unicode_group UnicodeGroups[] = {
        ...
        { {(u8 *)"Basic Latin", 11, 11},                           {0x0, 0x7F, 128},          {(u8 *)"arial.ttf", 9, 9} },
        { {(u8 *)"Latin-1 Supplement", 18, 18},                    {0x80, 0xFF, 128},         {(u8 *)"arial.ttf", 9, 9} },
        { {(u8 *)"Latin Extended-A", 16, 16},                      {0x100, 0x17F, 128},       {(u8 *)"arial.ttf", 9, 9} },
        { {(u8 *)"Latin Extended-B", 16, 16},                      {0x180, 0x24F, 208},       {(u8 *)"arial.ttf", 9, 9} },
        { {(u8 *)"IPA Extensions", 14, 14},                        {0x250, 0x2AF, 96},        {(u8 *)"arial.ttf", 9, 9} },
        ...
        { {(u8 *)"Greek and Coptic", 16, 16},                      {0x370, 0x3FF, 144},       {(u8 *)"arial.ttf", 9, 9} },
        { {(u8 *)"Cyrillic", 8, 8},                                {0x400, 0x4FF, 256},       {(u8 *)"arial.ttf", 9, 9} },
        { {(u8 *)"Cyrillic Supplement", 19, 19},                   {0x500, 0x527, 40},        {(u8 *)"arial.ttf", 9, 9} },
        ...
        { {(u8 *)"CJK Unified Ideographs", 22, 22},                {0x4E00, 0x9FCB, 20940},   {(u8 *)"malgun.ttf", 10, 10} },
