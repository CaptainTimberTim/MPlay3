...
{
    {NewStaticStringCompound("ä"), 228}, // 0xC3A4 : 195 164
    {NewStaticStringCompound("Ä"), 196}, // 0xC384 : 195 132
    {NewStaticStringCompound("ö"), 246}, // 0xC3B6 : 195 182
    {NewStaticStringCompound("Ö"), 214}, // 0xC396 : 195 150
    {NewStaticStringCompound("ü"), 252}, // 0xC3BC : 195 188
    {NewStaticStringCompound("Ü"), 220}, // 0xC39C : 195 156
    {NewStaticStringCompound("ß"), 223}, // 0xC39F : 195 159
};

inline font_atlas NewFontAtlas(r32 *FontSizes, u32 SizesCount, i32 HeightOffset);
...
internal void RenderText(struct renderer *Renderer, arena_allocator *Arena, font_size FontSize, string_c *Text, 
